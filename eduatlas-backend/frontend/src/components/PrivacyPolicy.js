	...
	render() {
		...
		return (
			<>
				...
				<Row className="below-nav container" gutter={16}>
					<Col span={24}>
						<h2>Privacy Policy</h2>
						<p>This Privacy Policy governs the manner in which Eduatlas collects, uses, maintains and discloses information collected from users (each, a “User”) of the http://www.Eduatlas.com website (“Site”)</p>
					</Col>
					<Col span={24}>
					...
					<Col span={24}>
						...
						<p>Our Site may use “cookies” to enhance User experience. User’s web browser places cookies on their hard drive for record-keeping purposes and sometimes to track information about them. User may choose to set their web browser to refuse cookies, or to alert you when cookies are being sent. If they do so, note that some parts of the Site may not function properly. How we use collected information
							Eduatlas may collect and use Users personal information for the following purposes:
					...
					<Col span={24}>
						...
						<p>By using Eduatlas.in, you signify your acceptance of this policy. If you do not agree to this policy, please do not use our Site. Your continued use of the Site following the posting of changes to this policy will be deemed your acceptance of those changes.</p>
					</Col>
					<Col span={24}>
						<h3>Contacting us</h3>
						<p>If you have any questions about this Privacy Policy, the practices of this site, or your dealings with this site, please contact us on contact@eduatlas.com.</p>
					</Col>
					<Col span={24}>
						<small>This document was last updated on July 19, 2018</small>
					</Col>
				</Row>
			</>
		);
